            ...
            <div class="col">
                <form action="{{ route('postTambahLulusan') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="prodi"autocomplete="off">
                            <span class="text-danger">
                                @error('prodi')
                                    {{ $message }}
                                @enderror
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="date" class="form-control" name="tahun_lulus"autocomplete="off">
                            <span class="text-danger">
                                @error('tahun_lulus')
                                    {{ $message }}
                                @enderror
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="pekerjaan_sekarang"autocomplete="off">
                            <span class="text-danger">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="pendidikan_lanjutan"autocomplete="off">
                            <span class="text-danger">
